...
namespace LordG.IO
{
    ...
    {
        public RARCFilesystem(FileBase file, ByteOrder order)
        {
            var buf = file.GetBuffer();
            mFile = new MemoryFile(buf)
            {
        ...
        internal FileBase mFile;
        public Dictionary<string, FileEntry> mFileEntries;
        public Dictionary<string, DirectoryEntry> mDirectoryEntries;
        private int unkVal;
    }
}
