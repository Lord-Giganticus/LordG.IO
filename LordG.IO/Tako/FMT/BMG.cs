...
namespace LordG.IO
{
    public class BMG
    {
        public BMG(FileBase file, bool Galaxy1 = false)
        {
            mFile = file;
            ...
            while (file.Position() != file.GetLength())
            {
                ...
                {
                    case "INF1":
                        mInfo = new INF1(ref file, Galaxy1);
                        break;
                }
            }
        }
    ...
    public struct INF1
    {
        public INF1(ref FileBase file, bool Galaxy1 = false)
        {
                ...
                while (cur != 0)
                {
                    ...
                    switch (cur)
                    {
                        ...
                        case 0x1A:
                            ...
                            {
                                case 0xFF:
                                    e.mMessage.Add(new SystemGroup(ref file, Galaxy1));
                                    break;

                                case 1:
                                    e.mMessage.Add(new DisplayGroup(ref file, Galaxy1));
                                    break;
                                ...
                                case 6:
                                    e.mMessage.Add(new NumberGroup(ref file, dataSize - 0x4, Galaxy1));
                                    break;
